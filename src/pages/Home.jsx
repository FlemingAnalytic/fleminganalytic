...
const PORTFOLIO_INTERNAL = [
  ...
  { category: "Government Data",  title: "Economic Indicators",  desc: "Federal Reserve data visualization. GDP, debt metrics, and time-series analysis from FRED API.",                                    href: "https://fleminganalytic.com/fred/",           isExternal: true, bg: "#f0fdf4", color: "#16a34a" },
